...
import { Github, Zap, Shield, BarChart3, ArrowRight, Code2, CheckCircle2, Star } from "lucide-react";
      ...
      <section className="py-20">
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {features.map(f => (
              <div key={f.title} className="rounded-xl border border-border bg-card p-6 card-hover">
